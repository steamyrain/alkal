...
$config['simpleauth_enable_remember_me'] = FALSE;

$config['simpleauth_enable_email_verification'] = FALSE;

$config['simpleauth_enforce_email_verification'] = FALSE;

$config['simpleauth_enable_brute_force_protection'] = FALSE;

$config['simpleauth_enable_acl'] = FALSE ;
...
$config['simpleauth_user_provider'] = 'AlkalUserProvider';

$config['simpleauth_users_table']  = 'alkal_users';
